#
#  Be sure to run `pod spec lint InMomentFeedbackKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
    ...
    s.description  = <<-DESC
    This is a simple library to launch and interact with an InMoment survey from within
    ...
    # Or just: s.author    = "Kyler Jensen"
    # s.authors            = { "Kyler Jensen" => "kjensen@inmoment.com" }
    # s.social_media_url   = "http://twitter.com/Kyler Jensen"
